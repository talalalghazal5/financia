...
export type StorageHash =
  StorageHashBase<'b01ff7fb47bba6e42256a387f74cea4ef51d375f62b03cb2ce80043a9477a098'>;
export type ExecutionHash =
  ExecutionHashBase<'24fb535192fb7502cc35a4d64b299cde68d1087803c372b0edca47f4499298c4'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Category: {
      ...
      readonly monthlyBudget: CodecTypes['pg/float8@1']['output'];
    ...
    readonly Transaction: {
      ...
      readonly isRecurring: CodecTypes['pg/bool@1']['output'];
    };
    readonly User: {
      readonly id: CodecTypes['pg/uuid@1']['output'];
      readonly name: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly Category: {
      ...
      readonly monthlyBudget: CodecTypes['pg/float8@1']['input'];
    ...
    readonly Transaction: {
      ...
      readonly isRecurring: CodecTypes['pg/bool@1']['input'];
    };
    readonly User: {
      readonly id: CodecTypes['pg/uuid@1']['input'];
      readonly name: CodecTypes['pg/text@1']['input'];
...
export namespace Models {
  ...
  export type public_Category = {
    id: CodecTypes['pg/uuid@1']['output'];
    name: CodecTypes['pg/text@1']['output'];
    monthlyBudget: CodecTypes['pg/float8@1']['output'];
  ...
  export type public_Transaction = {
    ...
    isRecurring: CodecTypes['pg/bool@1']['output'];
        ...
        readonly entries: {
              ...
              columns: {
                ...
                readonly type: {
                  ...
                  readonly default: {
                    ...
                    readonly value: DefaultLiteralValue<'pg/text@1', 'expense'>;
                  };
                };
                readonly date: {
          ...
          readonly valueSet: {
            readonly Type: {
              ...
              readonly values: readonly ['expense', 'income'];
            };
          };
        };
      };
          ...
          readonly Transaction: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly isRecurring: { readonly column: 'isRecurring' };
              };
            };
          };
          readonly User: {
